...
// Выводит true, так как функция ничего не возвращает, и по умолчанию возвращает undefined
// по любая функция в JavaScript возвращает значение, даже если явно не указано return
// И это значение по умолчанию будет undefined, если не указано иное
